...
USerial* USerial::OpenComPortWithFlowControl(bool& bOpened, int32 Port, int32 BaudRate, bool DTR, bool RTS)
{
...
bool USerial::OpenWFC(int32 nPort, int32 nBaud, bool bDTR, bool bRTS)
{
	if (nPort < 0)
	{
...
FString USerial::LineEndToStrBD(ELineEnd LineEnd)
{
	switch (LineEnd)
	{
	case ELineEnd::A:
